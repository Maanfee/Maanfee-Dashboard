        ...
        private static void AddOrUpdateIdentity(_BaseContext_SQLServer context)
        {
            ...
            if (!context.ApplicationUsers.Any())
            {
                ...
                var ApplicationUser = new List<ApplicationUser>
                {
                    ...
                    //    Name = "منصور فرشیدی",
                    //    Password = "123456",
                    //    //Phrase = "taste chaos demise shop razor dust cloud tissue power rural slim mountain".Encrypt(),
                    //    //PersonalCode = "maanfee",
                    //    PersonalCode = "44",   // 401011
                    //    UserName = "gordon",
            ...
            {
                //var Gordon = context.ApplicationUsers.FirstOrDefault(x => x.UserName == "gordon");
                var Admin = context.ApplicationUsers.FirstOrDefault(x => x.UserName == "admin");

                var Developer = context.AspNetRoles.FirstOrDefault(x => x.Name == UserRoleDefaultValue.Developer || x.Name == "توسعه گر");
                var Supervisor = context.AspNetRoles.FirstOrDefault(x => x.Name == UserRoleDefaultValue.Supervisor || x.Name == "ناظز");
            ...
            if (!context.AspNetRoleClaims.Any())
            {
                ...
                var IdentityRoleClaims = new List<IdentityRoleClaim<string>>
                {
                    ...
                    new IdentityRoleClaim<string>
                    {
                         ClaimType = "Permission.Users.Details",
                         ClaimValue = "Permission",
                         RoleId = "05e0986e-b0b0-46e6-a371-33dfa4184fa5",
                    },
                    new IdentityRoleClaim<string>
                    ...
                    new IdentityRoleClaim<string>
                    {
                         ClaimType = "Permission.UserServiceType.View",
                         ClaimValue = "Permission",
                         RoleId = "05e0986e-b0b0-46e6-a371-33dfa4184fa5",
                    },
                    new IdentityRoleClaim<string>
                    {
                         ClaimType = "Permission.UserServiceType.Create",
                         ClaimValue = "Permission",
                         RoleId = "05e0986e-b0b0-46e6-a371-33dfa4184fa5",
                    },
                    new IdentityRoleClaim<string>
                    {
                         ClaimType = "Permission.UserServiceType.Edit",
                         ClaimValue = "Permission",
                         RoleId = "05e0986e-b0b0-46e6-a371-33dfa4184fa5",
                    },
                    new IdentityRoleClaim<string>
                    {
                         ClaimType = "Permission.UserServiceType.Delete",
                         ClaimValue = "Permission",
                         RoleId = "05e0986e-b0b0-46e6-a371-33dfa4184fa5",
                    },
                    new IdentityRoleClaim<string>
                    {
                         ClaimType = "Permission.UserServiceType.Details",
                         ClaimValue = "Permission",
                         RoleId = "05e0986e-b0b0-46e6-a371-33dfa4184fa5",
                    },
                    new IdentityRoleClaim<string>
                    {
                         ClaimType = "Permission.DelegationSuccessor.View",
                         ClaimValue = "Permission",
                         RoleId = "05e0986e-b0b0-46e6-a371-33dfa4184fa5",
                    },
                    new IdentityRoleClaim<string>
                    {
                         ClaimType = "Permission.PublicRequests.View",
                         ClaimValue = "Permission",
                         RoleId = "05e0986e-b0b0-46e6-a371-33dfa4184fa5",
                    },
                    new IdentityRoleClaim<string>
                    {
                         ClaimType = "Permission.PublicRequests.Create",
                         ClaimValue = "Permission",
                         RoleId = "05e0986e-b0b0-46e6-a371-33dfa4184fa5",
                    },
                    new IdentityRoleClaim<string>
                    {
                         ClaimType = "Permission.PublicRequests.Edit",
                         ClaimValue = "Permission",
                         RoleId = "05e0986e-b0b0-46e6-a371-33dfa4184fa5",
                    },
                    new IdentityRoleClaim<string>
                    {
                         ClaimType = "Permission.PublicRequests.Delete",
                         ClaimValue = "Permission",
                         RoleId = "05e0986e-b0b0-46e6-a371-33dfa4184fa5",
                    },
                    new IdentityRoleClaim<string>
                    {
                         ClaimType = "Permission.PublicRequests.AdvancedFilter",
                         ClaimValue = "Permission",
                         RoleId = "05e0986e-b0b0-46e6-a371-33dfa4184fa5",
                    },
                    new IdentityRoleClaim<string>
                    {
                         ClaimType = "Permission.Swaggers.View",
                         ClaimValue = "Permission",
                         RoleId = "05e0986e-b0b0-46e6-a371-33dfa4184fa5",
                    },
...
#region Admin
                    ...
                    new IdentityRoleClaim<string>
                    {
                         ClaimType = "Permission.Roles.View",
                         ClaimValue = "Permission",
                         RoleId = "11d34b06-adaa-4797-bd7b-2026afa8c73f",
                    },
                    new IdentityRoleClaim<string>
                    {
                         ClaimType = "Permission.Roles.Permission",
