...
{
#nullable enable
    public partial class MudTreeViewItemOld<T> : MudComponentBase
    {
        ...
        [CascadingParameter]
        private MudTreeViewItemOld<T>? Parent { get; set; }
        ...
        [Parameter]
        [Category(CategoryTypes.TreeView.Behavior)]
        public RenderFragment<MudTreeViewItemOld<T>>? BodyContent { get; set; }
        ...
        internal async Task SelectItem(bool value, MudTreeViewItemOld<T>? source = null)
        {
            if (value == _isChecked)
                return;
        ...
        private void AddChild(MudTreeViewItemOld<T> item) => _childItems.Add(item);
        internal List<MudTreeViewItemOld<T>> ChildItems => _childItems.ToList();

        internal IEnumerable<MudTreeViewItemOld<T>> GetSelectedItems()
        {
            if (_isChecked)
                yield return this;
